    ...
    <footer className='bg-gradient-to-br from-black/20 via-gray-800 to-black/10 text-amber-200  overflow-hidden '>
        ...
        <div className='pl-60 grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
          ...
          <div>
            ...
            <ul className=' text-amber-100 font-medium'>
              ...
              <li >
                <Link to="https://www.linkedin.com/in/khaja-altaf-hussain-3b6b40347" target='_blank' className='hover:underline' >LikendIn
                </Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className=' text-amber-100 font-medium'>
              ...
              <li >
                <Link to="#" className='hover:underline'>Terms &amp; Conditions
                </Link>
              </li>
            </ul>
          </div>
      ...
      <div className=' pl-30 pb-4 pr-50 sm:flex sm:items-center sm:justify-between'>
        ...
        <div className=' flex mt-4 space-x-5 sm:justify-center sm:mt-0'>
          ...
          <Link to="https://x.com/mr_altaf47?s=21" target='_blank' className=' text-amber-300 hover:text-amber-200'>
            <svg 
          className=' w-4 h-4'
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="https://github.com/Khaja-Altaf-Hussain" className=' text-amber-300 hover:text-amber-200'>
            <svg 
          className=' w-4 h-4'
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
        ...
        // <p>© {currentYear} My Awesome SPA. All rights reserved.</p>
